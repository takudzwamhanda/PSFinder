...
const MySpots = () => {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const bookingData = {
      ...
      spotName: bookingSpot.name || bookingSpot.address || 'Parking Spot',
      spotAddress: bookingSpot.address || 'Address not available',
      spotPrice: bookingSpot.price || 0,
    ...
    try {
      ...
      const paymentData = {
        ...
        description: `Parking fee for ${bookingSpot.name || bookingSpot.address || 'Parking Spot'}`,
